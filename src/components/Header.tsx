...
function Header() {
  return (
    ...
    <header className='w-full flex flex-col gap-[16px]'>
      ...
      <div className='h-[30px] flex justify-center items-center gap-[16px] text-[14px]
        leading-[150%]'>
      ...
      {/* bottom div */}
        ...
        <div className='w-full h-[72px] bg-headerColor flex justify-between items-center xsm:px-[64px] p-y-[16px] px-[24px]  border-b-[1px] border-[black] '>

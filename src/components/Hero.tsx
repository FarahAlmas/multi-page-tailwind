...
//           mb-[24px]'>
//             Learn new skills online with ease</h1>
//           <p className='text-[18px] leading-[150%] mb-[40px]'>Discover a wide range of courses covering a variety of
//             <br/>
...
//         '>
//         <Image src= "/images/main.png" alt="mainImg" width={640} height={900} 
//         className='
//          w-[428px] xsm:w-[640px]
//          h-[600px] xsm:h-[900px]
//         '></Image>
...
//         overflow-x-auto
//         '>
//           <Image src={"/images/imge1.png"} alt='logos' width={124} height={38} className='w-[107px]xsm:w-[124px] h-[33px] xsm:h-[38px]'></Image>
//           <Image src={"/images/image2.png"} alt='logos' width={124} height={38} className='w-[107px]xsm:w-[124px] h-[33px] xsm:h-[38px]'></Image>
//           <Image src={"/images/image3.png"} alt='logos' width={124} height={38} className='w-[107px]xsm:w-[124px] h-[33px] xsm:h-[38px]'></Image>
//           <Image src={"/images/image4.png"} alt='logos' width={124} height={38} className='w-[107px]xsm:w-[124px] h-[33px] xsm:h-[38px]'></Image>
//           <Image src={"/images/image5.png"} alt='logos' width={124} height={38} className='w-[107px]xsm:w-[124px] h-[33px] xsm:h-[38px]'></Image>
//           <Image src={"/images/image6.png"} alt='logos' width={124} height={38} className='w-[107px]xsm:w-[124px] h-[33px] xsm:h-[38px]'></Image>
//         </div>
//       </div>
//       </section>
//       </>
